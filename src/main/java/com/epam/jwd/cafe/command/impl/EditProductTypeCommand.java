...
/**
 * The class provides editing {@link ProductType} by admin
 * @author Aleksey Vyshamirski
 * @version 1.0.0
 */
public class EditProductTypeCommand implements Command, AdminCommand {
    private static final Logger LOGGER = LogManager.getLogger(EditProductTypeCommand.class);
